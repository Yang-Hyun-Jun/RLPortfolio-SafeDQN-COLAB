...
def get_profitloss_curve(profitlosses, profitlosses_Bench=None, save_path=None):
    ...
    if profitlosses_Bench is not None:
        plt.plot(profitlosses_Bench, color='violet', label="B&H")
